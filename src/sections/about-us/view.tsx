...
function View():React.JSX.Element {
  return (
    <Box>
        <HeroFull />
      <HomeTrust mainText={`We specialize in developing software solutions through the synergy of skilled professionals and efficient processes.`} />
      <HomeWorkedWith />
      <HomeWorkedWith Links={companies} mainText={`Expert-level software development company`} />
        <ItServices />
        <TeamWork />
        <Section9 />
    </Box>
