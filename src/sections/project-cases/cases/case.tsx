    ...
    <Box sx={{ mx: "auto", my: 20 }}>
      ...
      >
        <Grid container columnGap={3} justifyContent="center">
              ...
              <Grid container justifyContent="start">
                ...
                <Grid item xs={12}>
                  <Box sx={{mb:9, py: 2, px: 4 }}>
                    ...
                    <Button  variant="contained" sx={{fontWeight:"bold",color:"#000",transition:"0.3s",bgcolor:'#b0f13c',':hover':{bgcolor:'#23C761'},py:1,px:{xs:2, md:4}}}>
                    Download Case Study
                    </Button>
                  </Box>
                </Grid>
          ...
          <Grid item xs={12} md={4.5} sx={{ background:'linear-gradient(145deg, rgba(92,210,223,1) 0%, rgba(75,154,209,1) 100%)',}}>
...
export default Case;
/* https://cdn-gnpmp.nitrocdn.com/zXfatNvCxdJLOJQwdBcjdAFpyWHclmaD/assets/images/optimized/rev-6b6d411/www.code-brew.com/wp-content/themes/Avada-Child-Theme/media/2023/09/aacbdc94ec2e5ba14bdb14d84cd2f750.portfolio-app-bharatpay.webp */
