...
const Case = () => {
  ...
  return Array?.from(items, (_, index) => (
    <Box
      key={index}
      sx={{ direction: index % 2 === 0 ? "rtl" : "ltr", mx: "auto", my: 20 }}
    >
      <Box
          ...
          >
            <Box
              sx={{
                width: "100%",
                height: "100%",
                backgourndSize: "auto auto",
                backgroundImage: `url('https://cdn-gnpmp.nitrocdn.com/zXfatNvCxdJLOJQwdBcjdAFpyWHclmaD/assets/images/optimized/rev-6b6d411/www.code-brew.com/wp-content/themes/Avada-Child-Theme/media/2023/09/9aceea39b7236ecc9721eaeab27e93aa.portfolio-app-bharatpay-bg.webp')`,
              }}
            >
              <Image
                style={{
